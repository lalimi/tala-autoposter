...
різниця між 500 і 50 000 переглядів це перші 2-3 слова. спочатку будуй ХУК, потім усе навколо нього.
    •    перше речення зупиняє скрол або пост мертвий. ЦІЛЬ 70-110 символів (приблизно 10-16 слів). це виміряно на 263 постах: хуки до 40 символів дали медіану 94 перегляди, 41-70 дали 185, а 71-110 дали 205. надто короткий хук не інтригує, він просто не встигає нічого пообіцяти. не ріж хук заради стислості
    •    у хуку має бути ДВІ частини: зачіпка (ситуація, зізнання, парадокс) + чітка обіцянка, що людина отримає далі. одна частина без другої не працює
    •    ніколи не починай з розгону, контексту чи “я”. цифра на початку не обовʼязкова: хуки з цифрою і без неї дають однаково (174 проти 170 медіанних переглядів). цифра має бути тільки там, де вона справді щось означає, інакше це просто шум
